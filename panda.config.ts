  ...
  theme: {
    extend: {
      ...
      slotRecipes: {
        ...
        field: {
          className: "field",
          slots: ["root", "errorText", "helperText", "input", "label", "select", "textarea"],
          base: {
            root: {
              display: "flex",
              flexDirection: "column",
        ...
        fieldset: {
          className: "fieldset",
          slots: ["root", "errorText", "helperText", "legend", "control"],
          base: {
            root: {
              display: "grid",
              borderTopWidth: "1px",
        ...
        slider: {
          className: "slider",
          slots: ["root", "label", "thumb", "valueText", "track", "range", "control", "markerGroup", "marker"],
          base: {
            root: {
              display: "flex",
              flexDirection: "column",
      ...
      semanticTokens: {
        colors: {
          ...
          neutral: {
            ...
            a1: {
              value: {
                _light: "{colors.neutral.light.a1}",
                _dark: "{colors.neutral.dark.a1}",
              },
            },
            a2: {
              value: {
                _light: "{colors.neutral.light.a2}",
                _dark: "{colors.neutral.dark.a2}",
              },
            },
            a3: {
              value: {
                _light: "{colors.neutral.light.a3}",
                _dark: "{colors.neutral.dark.a3}",
              },
            },
            a4: {
              value: {
                _light: "{colors.neutral.light.a4}",
                _dark: "{colors.neutral.dark.a4}",
              },
            },
            a5: {
              value: {
                _light: "{colors.neutral.light.a5}",
                _dark: "{colors.neutral.dark.a5}",
              },
            },
            a6: {
              value: {
                _light: "{colors.neutral.light.a6}",
                _dark: "{colors.neutral.dark.a6}",
              },
            },
            a7: {
              value: {
                _light: "{colors.neutral.light.a7}",
                _dark: "{colors.neutral.dark.a7}",
              },
            },
            a8: {
              value: {
                _light: "{colors.neutral.light.a8}",
                _dark: "{colors.neutral.dark.a8}",
              },
            },
            a9: {
              value: {
                _light: "{colors.neutral.light.a9}",
                _dark: "{colors.neutral.dark.a9}",
              },
            },
            a10: {
              value: {
                _light: "{colors.neutral.light.a10}",
                _dark: "{colors.neutral.dark.a10}",
              },
            },
            a11: {
              value: {
                _light: "{colors.neutral.light.a11}",
                _dark: "{colors.neutral.dark.a11}",
              },
            },
            a12: {
              value: {
                _light: "{colors.neutral.light.a12}",
                _dark: "{colors.neutral.dark.a12}",
              },
            },
            default: {
              value: {
